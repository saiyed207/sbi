...
$accountHolderName = $_SESSION['account_holder_name'];

// Use prepared statements to prevent SQL injection
$sql = "SELECT account_holder_name, account_balance, account_number FROM accounts WHERE account_number = ? AND account_holder_name = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ss", $accountNumber, $accountHolderName);
$stmt->execute();
...
if ($result->num_rows > 0) {
    ...
    echo '<div style="text-align: center; padding: 20px;">            
            <p style="font-size: 30px;color: white;">Account Holder: ' . $accountHolderName . '</p>
          </div>';
} else {
